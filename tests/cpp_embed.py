...
f1 = foo_python.create2("A", "create c++ class from python", 1)

info('foo_python.create("B, ....")')
f2 = foo_python.create2("B", "create c++ class from python", 2)

info('foo_python.create("PythonDerived1, ....")')
f3 = foo_python.create2("Python", "PythonDerived1", 3)

info('foo_python.create("PythonDerived2, ....")')
f4 = foo_python.create2("Python", "PythonDerived2", 4)
